    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <a href="{{ route('admin.supplier_categories.create') }}" class="btn btn-sm btn-success">اضافة جديد</a>
                                ...
                                <tbody>
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                              <a href="{{ route('admin.supplier_categories.edit',$info->id) }}" class="btn btn-sm btn-primary">تعديل</a>
                                                <a href="{{ route('admin.supplier_categories.delete',$info->id) }}" class="btn btn-sm btn-danger are_you_sure">حذف</a>
                                            </td>
