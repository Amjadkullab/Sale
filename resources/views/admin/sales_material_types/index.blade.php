                                ...
                                <tbody>
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                              <a href="{{ route('admin.sales_material_type.edit',$info->id) }}" class="btn btn-sm btn-primary">تعديل</a>
                                                <a href="{{ route('admin.sales_material_type.delete',$info->id) }}" class="btn btn-sm btn-danger are_you_sure">حذف</a>
                                            </td>
